...
The rack is a [Set](https://gitlab.com/special-circumstance/set/-/blob/trunk/doc/md/set.md) of the coroutines, to be iterated twice,
...
Wrapped to allow various asynchronies to proceed apace\.
